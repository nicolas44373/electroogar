  ...
  const tarjetasEstadisticas = [
    {
      ...
      valor: estadisticas.totalClientes.toString(),
      icon: Users,
      color: 'bg-blue-500',
    ...
    },
    {
      ...
      valor: formatearMoneda(estadisticas.ventasDelMes),
      icon: TrendingUp,
      color: 'bg-green-500',
    ...
    },
    {
      ...
      valor: formatearMoneda(estadisticas.cobrosDelMes),
      icon: DollarSign,
    ...
    },
    {
      ...
      valor: estadisticas.clientesVencidos.toString(),
      icon: AlertTriangle,
      color: 'bg-red-500',
    ...
    },
    {
      ...
      valor: formatearMoneda(estadisticas.montoTotalPendiente),
      icon: CreditCard,
      color: 'bg-orange-500',
              ...
              <div className="space-y-3">
                {notificacionesVencidas.slice(0, 5).map((notif, index) => (
                  <div key={index} className="flex justify-between items-center py-2 border-b border-gray-100 last:border-0">
                    <div>
                      <p className="font-medium text-sm text-gray-900">{notif.cliente_nombre}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-green-600">
              {((estadisticas.cobrosDelMes / estadisticas.ventasDelMes) * 100 || 0).toFixed(1)}%
            </div>
            <div className="text-sm text-gray-600">Efectividad de Cobros</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-blue-600">
              {formatearMoneda(estadisticas.montoTotalPendiente / estadisticas.totalClientes || 0)}
            </div>
            <div className="text-sm text-gray-600">Promedio por Cliente</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-orange-600">
              {((estadisticas.clientesVencidos / estadisticas.totalClientes) * 100 || 0).toFixed(1)}%
            </div>
