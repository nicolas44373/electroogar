              ...
              <table className="w-full min-w-[720px] text-sm">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-xs text-gray-500 uppercase">Descripción</th>
          ...
          <div className="relative w-full sm:max-w-lg bg-white rounded-t-xl sm:rounded-xl p-4 sm:p-6 shadow-lg">
            ...
            {movimientoAEliminar.tipo === 'venta' ? (
              <div className="mt-3 bg-yellow-50 border border-yellow-200 rounded p-3 text-sm text-yellow-800">
                <strong>⚠️ Advertencia:</strong> Al eliminar la venta, todos los pagos asociados volverán a estado "pendiente" y la venta se eliminará permanentemente.
              </div>
            ) : (
              <div className="mt-3 bg-blue-50 border border-blue-200 rounded p-3 text-sm text-blue-800">
                <strong>ℹ️ Información:</strong> Este pago volverá a estado "pendiente". La cuota seguirá existiendo y podrás registrar el pago más adelante.
              </div>
            )}
